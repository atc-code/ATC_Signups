...
// ====== CONFIG ======
const SHEET_ID = '1y0M6dYfZsNIcwDxDqZwCQuJeMyupXxBlavqw-QDmmEg';
...
const EVENT_DATE_ISO = '2025-11-27T23:59:59-04:00';
...
function doPost(e) {
  ...
  try {
    ...
    try {
      const subject = 'Thanks for serving — ATC Thanksgiving 2025';
      const lines = [];
      lines.push('Hi ' + name + ',');
      lines.push('');
      lines.push('Thank you for your Signup to serve at ATC Thanksgiving  (Thu, Nov - 27, 2025).');
